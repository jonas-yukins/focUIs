# Plainphone App Implementation

This document describes the implementation of the Plainphone app, which provides a minimal, text-only interface for launching apps on both Android and iOS platforms.

## Overview

The Plainphone app provides users with a distraction-free interface to launch their installed applications. Due to platform restrictions, the implementation differs between Android and iOS:
...
- **File**: `android/app/src/main/java/com/narbhacks/plainphone/InstalledAppsModule.kt`
- **Methods**:
...
```
apps/native/
├── android/app/src/main/java/com/narbhacks/plainphone/
...
│   └── screens/
│       └── PlainphoneScreen.tsx     # Main UI component
└── package.json                    # Dependencies
```

## Usage

1. **Navigate to Plainphone**: Tap the phone icon in the header
