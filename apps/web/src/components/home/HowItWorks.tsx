  ...
  const steps = [
    {
      ...
      description: "Get the Dumbphone app from the App Store or Google Play Store. It's free and takes just a few seconds to install.",
      icon: "📥",
    },
    {
      number: "02",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#7A7A7A] max-w-3xl mx-auto">
            Transform your smartphone into a dumbphone in just four simple steps.
          </p>
        </div>
